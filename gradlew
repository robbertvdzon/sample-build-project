...
#       noncompliant shell. For example:
#
#           ksh Gradle
#
...
#
#   (2) This script targets any POSIX-compliant shell, but it does require
#       /bin/sh.
#
#   The other way to enter is if you pass "-c" option to the shell.
#   Then the script is read from stdin.
#
##############################################################################
...
# This is reliable $( dirname ) for POSIX shells.
